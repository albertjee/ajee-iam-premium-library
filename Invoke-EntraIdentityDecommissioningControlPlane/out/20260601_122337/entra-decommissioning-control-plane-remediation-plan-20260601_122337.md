...
| Engagement ID   | ENG-004            |
| Assessor        | Albert Jee         |
| Assessment Date | 2026-06-01 12:24:55 UTC          |
...
### ACT-013 — DEC-USER-001: Test Decom User 1

| Field              | Value                                      |
|--------------------|--------------------------------------------|
| Action ID          | ACT-013                                  |
| Finding ID         | DEC-USER-001                      |
| Severity           | Medium (Risk Score: 55) |
| Object Type        | User                     |
| Display Name       | Test Decom User 1                    |
| Evidence           | Disabled user retains direct membership in 3 group(s): All Users, TestDecom-SecurityGroup-1, TestDecom-SecurityGroup-3                       |
| Recommended Action | Remove testdecom1@NewportHighPTSA.onmicrosoft.com from all group memberships              |
| Approval Status    | PendingReview                              |
| Consultant Note    | Standard group cleanup for disabled user                 |

---
### ACT-014 — DEC-USER-001: Test Decom User 2
...
| Severity           | Medium (Risk Score: 55) |
| Object Type        | User                     |
| Display Name       | Test Decom User 2                    |
| Evidence           | Disabled user retains direct membership in 3 group(s): All Users, TestDecom-SecurityGroup-1, TestDecom-SecurityGroup-2                       |
| Recommended Action | Remove testdecom2@NewportHighPTSA.onmicrosoft.com from all group memberships              |
| Approval Status    | PendingReview                              |
| Consultant Note    | Standard group cleanup for disabled user                 |

---
### ACT-015 — DEC-USER-001: Test Decom User 3
...
| Severity           | Medium (Risk Score: 55) |
| Object Type        | User                     |
| Display Name       | Test Decom User 3                    |
| Evidence           | Disabled user retains direct membership in 3 group(s): All Users, TestDecom-SecurityGroup-2, TestDecom-SecurityGroup-3                       |
| Recommended Action | Remove testdecom3@NewportHighPTSA.onmicrosoft.com from all group memberships              |
| Approval Status    | PendingReview                              |
| Consultant Note    | Standard group cleanup for disabled user                 |

---
### ACT-016 — DEC-APP-001: aljee demo
...
---
### ACT-017 — DEC-APP-001: P2P Server
...
---
### ACT-018 — DEC-APP-001: AdminDroid Service Application
...
---
### ACT-019 — DEC-APP-001: m365-security-assessment-tool-dev
...
---
### ACT-020 — DEC-APP-001: AJ-LAB-M365CopilotReadiness-ReadOnly
...
---
### ACT-021 — DEC-APP-001: Milestone_Plan
...
---
### ACT-022 — DEC-APP-003: PowerShelltoTeamsGraphAPI
...
| Recommended Action | Add a second owner to 'PowerShelltoTeamsGraphAPI' to ensure ownership continuity              |
| Approval Status    | PendingReview                              |
| Consultant Note    | Single-owner apps are a governance risk                 |

---
### ACT-023 — DEC-APP-003: Graph Python quick start
...
| Severity           | Medium (Risk Score: 45) |
| Object Type        | Application                     |
| Display Name       | Graph Python quick start                    |
| Evidence           | Application has only 1 owner — single point of failure for ownership continuity                       |
| Recommended Action | Add a second owner to 'Graph Python quick start' to ensure ownership continuity              |
| Approval Status    | PendingReview                              |
| Consultant Note    | Single-owner apps are a governance risk                 |

---
### ACT-024 — DEC-APP-003: Graph PowerShell quick start
...
| Severity           | Medium (Risk Score: 45) |
| Object Type        | Application                     |
| Display Name       | Graph PowerShell quick start                    |
| Evidence           | Application has only 1 owner — single point of failure for ownership continuity                       |
| Recommended Action | Add a second owner to 'Graph PowerShell quick start' to ensure ownership continuity              |
| Approval Status    | PendingReview                              |
| Consultant Note    | Single-owner apps are a governance risk                 |

---
### ACT-025 — DEC-APP-003: CopilotReadiness-V1
...
| Severity           | Medium (Risk Score: 45) |
| Object Type        | Application                     |
| Display Name       | CopilotReadiness-V1                    |
| Evidence           | Application has only 1 owner — single point of failure for ownership continuity                       |
| Recommended Action | Add a second owner to 'CopilotReadiness-V1' to ensure ownership continuity              |
| Approval Status    | PendingReview                              |
| Consultant Note    | Single-owner apps are a governance risk                 |

---
### ACT-026 — DEC-SPN-001: Access Package Builder
...
---
### ACT-027 — DEC-SPN-001: PowerShelltoTeamsGraphAPI
...
---
### ACT-028 — DEC-SPN-001: AdminDroid Office 365 Reporter
...
---
### ACT-029 — DEC-SPN-001: AdminDroid Office 365 Reporter - Mail App
...
---
### ACT-030 — DEC-SPN-001: AdminDroid Office 365 Reporter - Sign In
...
---
### ACT-032 — DEC-SPN-001: ca-policy-analyzer
...
---
### ACT-033 — DEC-SPN-001: Modern Workplace Tools
...
---
### ACT-034 — DEC-SPN-001: iOS Accounts
...
---
### ACT-035 — DEC-SPN-001: M365 MCP Server for Claude
...
---
### ACT-037 — DEC-SPN-001: FTOP-Multi [wsfed enabled]
...
---
### ACT-038 — DEC-SPN-001: Toreon Security Office
...
---
### ACT-039 — DEC-SPN-001: M365 MCP Client for Claude
...
---
### ACT-040 — DEC-SPN-001: aljee demo
...
---
### ACT-042 — DEC-SPN-001: M365Permissions PowerShell Module
...
---
### ACT-043 — DEC-SPN-001: Microsoft Tech Community
...
---
### ACT-044 — DEC-SPN-001: mmrpreview
...
---
### ACT-045 — DEC-SPN-001: Microsoft Graph PowerShell
