...
Describe 'Safety — Rev3.1 Write Isolation and Guest Safety Invariants' {
    ...
    It 'Entry point ToolVersion matches the current release version' {
...
Describe 'ReleaseValidation.psm1 — Rev3.1 Validation Checks' {
    ...
    It 'ReleaseValidation checks that ToolVersion is Rev4.10' {
        ...
        ($result.Errors | Where-Object { $_ -match 'Rev4\.10' }) | Should -Not -BeNullOrEmpty
    }
