...
### Test Count
- **2452 total, 2452 passing, 0 failed** (on this branch: prior baseline 2441 + 11 new).
  PR #27 (NhiAnalysis OAuth fix, +7) merges independently; combined expectation after
  both merge: 2459.
