...
function Test-DecomMicrosoftPlatformIdentity {
    ...
    $knownMicrosoftTenantIds = @(
        # Microsoft tenant IDs observed in live platform app registrations.
        'f8cdef31-a31e-4b4a-93e4-5f571e91255a',
        '72f988bf-86f1-41af-91ab-2d7cd011db47'
    )

    $fallbackKnownMicrosoftAppIds = @(
        # Tight fallback for live-observed Microsoft service principals. The JSON catalog is the primary source.
