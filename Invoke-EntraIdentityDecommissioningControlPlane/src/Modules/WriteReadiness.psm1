...
function Get-DecomExecutionScopeRegistry {
    ...
    return @(
        ...
        [PSCustomObject]@{
            ...
            WriteScope = 'GroupMember.ReadWrite.All + Policy.Read.All'
...
function Get-DecomRev3WriteCandidateRegistry {
    ...
    return @(
        ...
        [PSCustomObject]@{
            ...
            CandidateStatus = 'Candidate'
            ProposedWriteScope = 'RoleManagement.ReadWrite.Directory'
            RiskLevel = 'High'
        ...
        [PSCustomObject]@{
            ...
            CandidateStatus = 'Deferred'
            ProposedWriteScope = 'GroupMember.ReadWrite.All + Policy.Read.All'
            RiskLevel = 'High'
